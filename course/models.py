...
class Course(models.Model):
    ...
    # 课程难易程度
    degree = models.CharField(max_length=2, choices=(("dj", "低级"), ("zj", "中级"), ("gj", "高级")))
    # 学习时间
    learn_time = models.IntegerField(default=0, verbose_name=u"学习时间")
    # 学习人数
    learn_nums = models.IntegerField(default=0, verbose_name=u"学习人数")
    # 收藏人数
    favs_nums = models.IntegerField(default=0, verbose_name=u"收藏人数")
    # 课程封面图片
...
class CourseResource(models.Model):
    ...
    dowm = models.FileField(max_length=100, upload_to="course/resource/%Y/%m", verbose_name=u"")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
